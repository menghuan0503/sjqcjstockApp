 ...
 * 精英实时赛况更多页面
 */
public class essencematchActivity extends Activity {
    // 获取控件
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sesencematch_list);
        // 将Activity反复链表
    ...
    private void initView() {
        dialog = new ProgressDialog(essencematchActivity.this);
        ...
        essencematchAdapter = new essencematchAdapter(
                essencematchActivity.this, listessencematchData);
