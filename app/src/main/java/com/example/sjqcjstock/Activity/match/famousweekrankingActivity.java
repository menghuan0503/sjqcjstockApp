...
public class famousweekrankingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.famousweekrankingmatch_list);
    ...
    private void initView() {
        ...
        famousmanchAdapter = new famousmanmatchAdapter(famousweekrankingActivity.this, famousmanematchData);
                ...
                for (Map<String, Object> map : lists) {
                    ...
                    for (Map<String, Object> statusstrmap : statusstrlists) {
                        ...
                        for (Map<String, Object> ballot1strmap : ballot1strlists) {
                            ...
                            String ballot_idstr = ballot1strmap.get("ballot_id")+"";
                            //用户id
