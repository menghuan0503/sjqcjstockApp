...
public class systemMessageActivity extends Activity {
    ...
    private void findView() {
        ...
        adapter = new systemMessageAdapter(systemMessageActivity.this);
        ...
        messageListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!"0".equals(feedId)) {
                    // 跳转到对于的微博页面
                    Intent intent = new Intent(systemMessageActivity.this, forumnotedetailActivity.class);
    ...
    private void geneItems() {
        new SendSystemMessageTask().execute(new TaskParams(Constants.systemMessagedUrl,
