...
public class discussareanoteAdapter extends BaseAdapter {
    String isdigg;
    private Context context;
    private ArrayList<HashMap<String, Object>> listData;

    public discussareanoteAdapter(Context context) {
        super();
...
//		//动态加载布局		LayoutInflater mInflater=LayoutInflater.from(context);
//		//convertView.findViewById(R.id.shortweibolay1).getVisibility()==0
//		View repostview=null;
//		if("repost".equals((String)listData.get(position).get("type"))){
//			repostview=mInflater.inflate(R.layout.list_item_repostcommonnote, null);
//
//		}
//
//		View postview=null;
...
//		}
        ...
        //if(convertView==null||convertView.findViewById(R.id.shortweibolay1).getVisibility()==0||convertView.findViewById(R.id.repostlin1).getVisibility()==0){
        if (convertView == null) {
...
//		
        ...
        //短微博图片处理
        //String attach_urlstr= (String)listData.get(position).get("attach_url");
