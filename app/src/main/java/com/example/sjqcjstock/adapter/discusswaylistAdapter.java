...
public class discusswaylistAdapter extends BaseAdapter{

	private Context context;
	private ArrayList<HashMap<String,Object>> listData;

	
	public discusswaylistAdapter(Context context,ArrayList<HashMap<String,Object>> listData) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView=mInflater.inflate(R.layout.list_item_discussway, null);
		}
