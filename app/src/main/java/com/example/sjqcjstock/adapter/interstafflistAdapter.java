...
public class interstafflistAdapter extends BaseAdapter{

	private Context context;
	private ArrayList<HashMap<String,Object>> listData;

	
	public interstafflistAdapter(Context context,ArrayList<HashMap<String,Object>> listData) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView=mInflater.inflate(R.layout.list_item_interstaff, null);
		}
