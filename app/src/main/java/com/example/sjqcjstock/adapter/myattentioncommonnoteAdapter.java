...
public class myattentioncommonnoteAdapter extends BaseAdapter {
    ...
    public myattentioncommonnoteAdapter(Context context) {
        super();
            ...
            holder.repostlin1.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    try {
                        ...
                        intent.putExtra("weibo_id", listData.get(position).get("source_feed_idstr"));
...
//		
        ...
        holder.createtime11.setText(listData.get(position).get("create"));

        //TextView repost_count2=(TextView)convertView.findViewById(R.id.repost_count3);
        holder.repost_count2.setText(listData.get(position).get("repost_count"));

        //TextView comment_count2=(TextView)convertView.findViewById(R.id.comment_count3);
        holder.comment_count2.setText(listData.get(position).get("comment_count"));

        final TextView digg_count2 = (TextView) convertView.findViewById(R.id.digg_count3);
        digg_count2.setText(listData.get(position).get("digg_count"));
