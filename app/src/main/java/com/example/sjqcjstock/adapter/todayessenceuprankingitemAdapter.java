...
public class todayessenceuprankingitemAdapter extends BaseAdapter{

	private Context context;
	private ArrayList<HashMap<String,Object>> listData;

	
	public todayessenceuprankingitemAdapter(Context context,ArrayList<HashMap<String,Object>> listData) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		convertView=mInflater.inflate(R.layout.list_item_todayessenceupranking, null);
		...
		ImageView image=(ImageView)convertView.findViewById(R.id.user_image1);
		 // image.setBackgroundResource((Integer)listData.get(position).get("friend_image"));
		  ...
		  TextView rankcount1=(TextView)convertView.findViewById(R.id.rankcount1);
		  rankcount1.setText((String)listData.get(position).get("rankcountstr"));
