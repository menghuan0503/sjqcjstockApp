...
//		.bitmapConfig(Bitmap.Config.ARGB_4444).build();//設置圖片配置信息  對圖片進行處理防止內存溢出
	...
	private static void initfacemap2() {
		...
		facemap2.put("ciya",R.drawable.ciya);facemap2.put("da",R.drawable.da);
		facemap2.put("dabian",R.drawable.dabian);facemap2.put("dabing",R.drawable.dabing);
		facemap2.put("dajiao",R.drawable.dajiao);facemap2.put("daku",R.drawable.daku);
		facemap2.put("dangao",R.drawable.dangao);facemap2.put("danu",R.drawable.danu);
		facemap2.put("dao",R.drawable.dao);facemap2.put("deyi",R.drawable.deyi);
		facemap2.put("diaoxie",R.drawable.diaoxie);facemap2.put("e",R.drawable.e);
		facemap2.put("fadai",R.drawable.fadai);facemap2.put("fadou",R.drawable.fadou);
		facemap2.put("fan",R.drawable.fan);facemap2.put("fanu",R.drawable.fanu);
		facemap2.put("feiwen",R.drawable.feiwen);facemap2.put("fendou",R.drawable.fendou);
		facemap2.put("gangga",R.drawable.gangga);facemap2.put("geili",R.drawable.geili);
		facemap2.put("gouyin",R.drawable.gouyin);facemap2.put("guzhang",R.drawable.guzhang);
		facemap2.put("haha",R.drawable.haha);facemap2.put("haixiu",R.drawable.haixiu);
		facemap2.put("haqian",R.drawable.haqian);facemap2.put("hua",R.drawable.hua);
		facemap2.put("huaixiao",R.drawable.huaixiao);facemap2.put("hufen",R.drawable.hufen);
		facemap2.put("huishou",R.drawable.huishou);facemap2.put("huitou",R.drawable.huitou);
		facemap2.put("jidong",R.drawable.jidong);facemap2.put("jingkong",R.drawable.jingkong);
		facemap2.put("jingya",R.drawable.jingya);facemap2.put("kafei",R.drawable.kafei);
		facemap2.put("keai",R.drawable.keai);facemap2.put("kelian",R.drawable.kelian);
		facemap2.put("ketou",R.drawable.ketou);facemap2.put("kiss",R.drawable.kiss);
		facemap2.put("ku",R.drawable.ku);facemap2.put("kuaikule",R.drawable.kuaikule);
		facemap2.put("kulou",R.drawable.kulou);facemap2.put("kun",R.drawable.kun);
		facemap2.put("lanqiu",R.drawable.lanqiu);facemap2.put("lenghan",R.drawable.lenghan);
		facemap2.put("liuhan",R.drawable.liuhan);facemap2.put("liulei",R.drawable.liulei);
		facemap2.put("liwu",R.drawable.liwu);facemap2.put("love",R.drawable.love);
		facemap2.put("ma",R.drawable.ma);facemap2.put("meng",R.drawable.meng);
		facemap2.put("nanguo",R.drawable.nanguo);facemap2.put("no",R.drawable.no);
		facemap2.put("ok",R.drawable.ok);facemap2.put("peifu",R.drawable.peifu);
		facemap2.put("pijiu",R.drawable.pijiu);facemap2.put("pingpang",R.drawable.pingpang);
		facemap2.put("pizui",R.drawable.pizui);facemap2.put("qiang",R.drawable.qiang);
		facemap2.put("qinqin",R.drawable.qinqin);facemap2.put("qioudale",R.drawable.qioudale);
		facemap2.put("qiu",R.drawable.qiu);facemap2.put("quantou",R.drawable.quantou);
		facemap2.put("ruo",R.drawable.ruo);facemap2.put("se",R.drawable.se);
		facemap2.put("shandian",R.drawable.shandian);facemap2.put("shengli",R.drawable.shengli);
		facemap2.put("shenma",R.drawable.shenma);facemap2.put("shuai",R.drawable.shuai);
		facemap2.put("shuijiao",R.drawable.shuijiao);facemap2.put("taiyang",R.drawable.taiyang);
		facemap2.put("tiao",R.drawable.tiao);facemap2.put("tiaopi",R.drawable.tiaopi);
		facemap2.put("tiaopi",R.drawable.tiaopi);facemap2.put("tiaosheng",R.drawable.tiaosheng);
		facemap2.put("tiaowu",R.drawable.tiaowu);facemap2.put("touxiao",R.drawable.touxiao);
		facemap2.put("tu",R.drawable.tu);facemap2.put("tuzi",R.drawable.tuzi);
		facemap2.put("wabi",R.drawable.wabi);facemap2.put("weiqu",R.drawable.weiqu);
		facemap2.put("weixiao",R.drawable.weixiao);facemap2.put("wen",R.drawable.wen);
		facemap2.put("woshou",R.drawable.woshou);facemap2.put("xia",R.drawable.xia);
		facemap2.put("xianwen",R.drawable.xianwen);facemap2.put("xigua",R.drawable.xigua);
		facemap2.put("xinsui",R.drawable.xinsui);facemap2.put("xu",R.drawable.xu);
		facemap2.put("yinxian",R.drawable.yinxian);facemap2.put("yongbao",R.drawable.yongbao);
		facemap2.put("youhengheng",R.drawable.youhengheng);facemap2.put("youtaiji",R.drawable.youtaiji);
		facemap2.put("yueliang",R.drawable.yueliang);facemap2.put("yun",R.drawable.yun);
		facemap2.put("zaijian",R.drawable.zaijian);facemap2.put("zhadan",R.drawable.zhadan);
		facemap2.put("zhemo",R.drawable.zhemo);facemap2.put("zhuakuang",R.drawable.zhuakuang);
		facemap2.put("zhuanquan",R.drawable.zhuanquan);facemap2.put("zhutou",R.drawable.zhutou);
		facemap2.put("zuohengheng",R.drawable.zuohengheng);facemap2.put("zuotaiji",R.drawable.zuotaiji);
